...
//{
//    public class RedisQueue_dead : IQueue
//    {
//        private const string _channelHostChange = "channel_host_change";

//        private readonly ILogger<RedisQueue_dead> _logger;
...
//        public RedisQueue_dead(ILogger<RedisQueue_dead> logger, ISubscriber subscriber, IHostApplicationLifetime applicationLifetime, IDateTimeProvider dateTimeProvider)
//        {
//            _logger = logger;
