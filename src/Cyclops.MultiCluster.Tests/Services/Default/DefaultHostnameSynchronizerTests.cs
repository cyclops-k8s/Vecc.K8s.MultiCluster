...
namespace Cyclops.MultiCluster.Tests.Services.Default
{
    public class DefaultHostnameSynchronizerTests
    {
        ...
        public async Task SynchronizeRemoteClustersAsync_WithPeer_SetsClusterCache()
        {
            ...
            {
                new Cyclops.MultiCluster.Models.Api.HostModel
                {
                    Hostname = "test.example.com",
                    HostIPs = new[]
                    {
                        new Cyclops.MultiCluster.Models.Api.HostIP { IPAddress = "10.0.0.1", Priority = 1, Weight = 50 }
                    }
                }
            };
        ...
        public async Task SynchronizeRemoteClustersAsync_MultiplePeers_SyncsBoth()
        {
            ...
            var hosts1 = new[] { new Cyclops.MultiCluster.Models.Api.HostModel { Hostname = "a.com", HostIPs = Array.Empty<Cyclops.MultiCluster.Models.Api.HostIP>() } };
            var hosts2 = new[] { new Cyclops.MultiCluster.Models.Api.HostModel { Hostname = "b.com", HostIPs = Array.Empty<Cyclops.MultiCluster.Models.Api.HostIP>() } };
