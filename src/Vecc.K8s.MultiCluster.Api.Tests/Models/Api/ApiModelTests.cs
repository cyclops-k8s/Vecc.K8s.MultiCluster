namespace Vecc.K8s.MultiCluster.Api.Tests.ApiModels
{
    public class ApiModelTests
    {
        ...
        {
            var hostIp = new Vecc.K8s.MultiCluster.Api.Models.Api.HostIP();
        ...
        {
            var model = new Vecc.K8s.MultiCluster.Api.Models.Api.HostModel();
        ...
        public void HostModel_SetAndGet()
        {
            var model = new Vecc.K8s.MultiCluster.Api.Models.Api.HostModel
            {
                ...
                HostIPs = new[]
                {
                    new Vecc.K8s.MultiCluster.Api.Models.Api.HostIP { IPAddress = "10.0.0.1" }
                }
            };
