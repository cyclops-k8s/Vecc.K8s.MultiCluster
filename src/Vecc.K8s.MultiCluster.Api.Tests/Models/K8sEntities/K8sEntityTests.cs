...
namespace Vecc.K8s.MultiCluster.Api.Tests.K8sEntityModels
{
    public class V1ClusterCacheTests
    {
        ...
        public void Constructor_SetsKindAndApiVersion()
        {
            ...
            Assert.Equal("multicluster.veccsolutions.io/v1alpha", cache.ApiVersion);
        }
    ...
    public class V1GslbTests
    {
        ...
        public void Constructor_SetsKindAndApiVersion()
        {
            ...
            Assert.Equal("multicluster.veccsolutions.io/v1alpha", gslb.ApiVersion);
        }
        ...
        {
            var gslb = new V1Gslb();
            Assert.NotNull(gslb.ObjectReference);
            Assert.Empty(gslb.Hostnames);
            Assert.Null(gslb.IPOverrides);
            Assert.Equal(0, gslb.Priority);
            Assert.Equal(50, gslb.Weight);
        }
